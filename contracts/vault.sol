...
contract vault {
    ...
    //申购转账
    function depositTransfer(uint256 amountIn,uint256 amountOut,address XOwner,address tokenX) public{
        require(msg.sender==subscribe,"Not subscribe");
        require( IERC20(tokenX).balanceOf(XOwner)>= amountIn,"Insufficient fund");
    ...
    //赎回转账
    function withdrawTransfer(uint256 amountIn,uint256 amountOut,address XOwner,address tokenX) public{
        require(msg.sender==subscribe,"Not subscribe"); 
        tokenF tokenFContract= tokenF(AddrF);
