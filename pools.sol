...
contract Swap {
    ...
    // 获取Lp池子的Index
    function getLpIndex(address _tokenA, address _tokenB) public view returns (uint256){
    ...
    // 计算可拿到的带滑点的数量
    function calculateNetAmountOut(uint256 amountIn, address[] calldata path) public view returns (uint256) {
